...
#include "../../../../../src/PlotJuggler/plotjuggler_app/plot_docker.h"
...
void DraggableToolbar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        DraggableToolbar *_t = static_cast<DraggableToolbar *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject DraggableToolbar::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_DraggableToolbar.data,
      qt_meta_data_DraggableToolbar,  qt_static_metacall, nullptr, nullptr}
};
...
const QMetaObject DockWidget::staticMetaObject = {
    { &ads::CDockWidget::staticMetaObject, qt_meta_stringdata_DockWidget.data,
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        PlotDocker *_t = static_cast<PlotDocker *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (PlotDocker::*_t)(PlotWidget * );
...
const QMetaObject PlotDocker::staticMetaObject = {
    { &ads::CDockManager::staticMetaObject, qt_meta_stringdata_PlotDocker.data,
      qt_meta_data_PlotDocker,  qt_static_metacall, nullptr, nullptr}
};
