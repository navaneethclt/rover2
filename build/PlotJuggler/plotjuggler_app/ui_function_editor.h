...
public:
    ...
    void setupUi(QWidget *FunctionEditor)
    {
        ...
        label_linkeChannel->setObjectName(QStringLiteral("label_linkeChannel"));
        ...
        pushButtonDeleteCurves->setObjectName(QStringLiteral("pushButtonDeleteCurves"));
        ...
        listAdditionalSources->setObjectName(QStringLiteral("listAdditionalSources"));
        ...
        buttonLoadFunctions->setObjectName(QStringLiteral("buttonLoadFunctions"));
        ...
        buttonSaveFunctions->setObjectName(QStringLiteral("buttonSaveFunctions"));
        ...
        buttonSaveCurrent->setObjectName(QStringLiteral("buttonSaveCurrent"));
        ...
        snippetsListSaved->setObjectName(QStringLiteral("snippetsListSaved"));
        ...
        snippetPreview->setObjectName(QStringLiteral("snippetPreview"));
        ...
        labelSemaphore->setObjectName(QStringLiteral("labelSemaphore"));
        ...
        globalVarsTextField->setObjectName(QStringLiteral("globalVarsTextField"));
        ...
        mathEquation->setObjectName(QStringLiteral("mathEquation"));
    ...
    {
        FunctionEditor->setWindowTitle(QApplication::translate("FunctionEditor", "Function editor", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        label_linkeChannel->setToolTip(QApplication::translate("FunctionEditor", "<html><head/><body><p>The timeseries that provides the (time,value) pairs to compute the funtion <span style=\" font-weight:600;\">calc(time,value)</span></p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        label_linkeChannel->setText(QApplication::translate("FunctionEditor", "<html><head/><body><p>Input timeseries. Provides arguments <span style=\" font-weight:600;\">time </span>and<span style=\" font-weight:600;\"> value</span>: </p></body></html>", Q_NULLPTR));
        lineEditSource->setPlaceholderText(QApplication::translate("FunctionEditor", "drag & drop here the input timeseries", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        label_2->setToolTip(QString());
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("FunctionEditor", "Additional source timeseries:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        pushButtonDeleteCurves->setToolTip(QApplication::translate("FunctionEditor", "<html><head/><body><p>Remove selected time series.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        pushButtonDeleteCurves->setText(QString());
#ifndef QT_NO_TOOLTIP
        listAdditionalSources->setToolTip(QApplication::translate("FunctionEditor", "<html><head/><body><p>Drag &amp; Drop your additional timeseries here.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        label_5->setText(QApplication::translate("FunctionEditor", "Function library:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        buttonLoadFunctions->setToolTip(QApplication::translate("FunctionEditor", "<html><head/><body><p>Import functions from a XML library.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        buttonLoadFunctions->setText(QString());
#ifndef QT_NO_TOOLTIP
        buttonSaveFunctions->setToolTip(QApplication::translate("FunctionEditor", "<html><head/><body><p>Export functions from a XML library.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        buttonSaveFunctions->setText(QString());
#ifndef QT_NO_TOOLTIP
        buttonSaveCurrent->setToolTip(QApplication::translate("FunctionEditor", "<html><head/><body><p>Save the current function in the library.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        buttonSaveCurrent->setText(QString());
#ifndef QT_NO_TOOLTIP
        snippetsListSaved->setToolTip(QApplication::translate("FunctionEditor", "<html><head/><body><p>To load this function, <span style=\" font-weight:600;\">double-click</span> on it.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        label_7->setText(QApplication::translate("FunctionEditor", "Function Preview:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        label_name->setToolTip(QApplication::translate("FunctionEditor", "<html><head/><body><p>Name of the new time series.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        label_name->setText(QApplication::translate("FunctionEditor", "New name:", Q_NULLPTR));
        nameLineEdit->setText(QString());
        nameLineEdit->setPlaceholderText(QApplication::translate("FunctionEditor", "name the new timeseries", Q_NULLPTR));
        labelSemaphore->setText(QString());
        label->setText(QApplication::translate("FunctionEditor", "<html><head/><body><p>Global variables</p></body></html>", Q_NULLPTR));
        pushButtonHelp->setText(QApplication::translate("FunctionEditor", "Help", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        globalVarsTextField->setToolTip(QApplication::translate("FunctionEditor", "<html><head/><body><p>Portion of code outside the function.</p><p>Usefull to add global variables.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        globalVarsTextField->setPlaceholderText(QApplication::translate("FunctionEditor", "Declare your global variables here", Q_NULLPTR));
        labelFunction->setText(QApplication::translate("FunctionEditor", "function( time, value )", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        mathEquation->setToolTip(QApplication::translate("FunctionEditor", "<html><head/><body><p>Write your function implementation here. </p><p>It <span style=\" font-weight:600;\">must</span> return a new value. </p><p>The time used in the new time series will be the same.</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mathEquation->setPlaceholderText(QApplication::translate("FunctionEditor", "Declare your function here", Q_NULLPTR));
        pushButtonCreate->setText(QApplication::translate("FunctionEditor", "Create New Time Series", Q_NULLPTR));
        pushButtonCancel->setText(QApplication::translate("FunctionEditor", "Close", Q_NULLPTR));
    } // retranslateUi
