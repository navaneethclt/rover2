...
#include "../../../../../src/PlotJuggler/plotjuggler_base/include/PlotJuggler/datastreamer_base.h"
...
void PJ::DataStreamer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        DataStreamer *_t = static_cast<DataStreamer *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (DataStreamer::*_t)(std::string );
        ...
        {
            typedef void (DataStreamer::*_t)(int );
...
const QMetaObject PJ::DataStreamer::staticMetaObject = {
    { &PlotJugglerPlugin::staticMetaObject, qt_meta_stringdata_PJ__DataStreamer.data,
      qt_meta_data_PJ__DataStreamer,  qt_static_metacall, nullptr, nullptr}
};
