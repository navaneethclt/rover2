...
echo_and_run cd "/home/rover/catkin_ws2/src/ds4_driver"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/rover/catkin_ws2/src/ds4_driver/setup.py" \
     \
    build --build-base "/home/rover/catkin_ws2/build/ds4_driver" \
    install \
    --root="${DESTDIR-/}" \
