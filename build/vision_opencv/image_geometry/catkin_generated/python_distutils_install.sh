...
echo_and_run cd "/home/rover/catkin_ws2/src/vision_opencv/image_geometry"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/rover/catkin_ws2/src/vision_opencv/image_geometry/setup.py" \
    egg_info --egg-base /home/rover/catkin_ws2/build/vision_opencv/image_geometry \
    build --build-base "/home/rover/catkin_ws2/build/vision_opencv/image_geometry" \
    install \
    --root="${DESTDIR-/}" \
